...
@section('main_content')
    ...
    <div class="container-fluid pt-5">
        <h3 style="text-align: center; margin-bottom:40px " id="title">گزارش فروشات داخلی</h3>
        <form action="{{route('getInsideReport')}}" id="report">
            <div class="row">
                <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <table id="print_table" style="display:none; width: 100%">
                    <tr>
                        <td>نوع مصرف: <span id="expense_print"></span></td>
                        <td>نحوه گزارش: <span id="type_print"></span></td>
